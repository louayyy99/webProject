...
if($row['category']=='yoga'){
    $i++;
}
else if($row['category']=='fitness'){
    $j++;
}else
if($row['category']=='body'){
 ...
 $dataPoints = array(
     array("label"=> "yoga", "y"=>$i ),
     array("label"=> "body", "y"=> $l),
     array("label"=> "fitness", "y"=> $j),
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	exportEnabled: true,
	title:{
		text: "Les types des evennements"
	},
	subtitles: [{
		text: "La disponibilité des cours "
	}],
	data: [{
		type: "pie",
		showInLegend: "true",
