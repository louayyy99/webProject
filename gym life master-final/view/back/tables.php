					...
					<ul class="nofitications-dropdown">
						...
						<li class="dropdown head-dpdn">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#">
									<div class="task-info">
										<span class="task-desc">Database upcategory</span><span class="percentage">40%</span>
										<div class="clearfix"></div>	
									</div>
		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                foreach ($listeposts as $l ) { ?> 
							...
							<div class="btn-group"><button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
 Edit User
</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="../../core/modifier_Posts.php" method="POST">
  <div class="form-group">
    <label for="title">title</label>
    <input type="text" class="form-control" value="<?php echo $l['title'] ; ?>" placeholder="title" name="title">
  </div>
  <div class="form-group">
    <label for="content">content</label>
    <input type="text" class="form-control"value="<?php echo $l['content'] ; ?>"  placeholder="content" name="content" >
    
  </div>

  <div class="form-group">
    <label for="category">category </label>
    <input type="text" class="form-control"value="<?php echo $l['category'] ; ?>"  placeholder="category" name="category">
  </div>
  <div class="form-group">
  <input type="text" class="form-control"value="<?php echo $l['category'] ; ?>"  placeholder="category" name="category">
 
  <input type="file" value="<?php echo $l['image'] ; ?>" name="image">
  <input type="hidden" value="<?php echo $l['ID'] ; ?>" name="idd">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Save changes</button>
                     ...
                     <form Action="./../../core/Supprimer_Posts.php" method="post"> 
                     <input type="hidden" name="id=" value="<?php echo $l['ID'] ; ?>">
                       <button type="submit" class="btn btn-danger" href="#">Delete Post<i class="icon_close_alt2"></i></a></form>
                      </div>
                    </td>
								</tr>
								<?php
